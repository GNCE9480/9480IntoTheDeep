...
public class FConstants {
    static {
        ...
        FollowerConstants.xMovement = -101.56;
        FollowerConstants.yMovement = -101.5;

        FollowerConstants.forwardZeroPowerAcceleration = -62.085;
        FollowerConstants.lateralZeroPowerAcceleration = -114.776;
